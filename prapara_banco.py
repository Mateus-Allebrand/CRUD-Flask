...
usuarios = [
    ...
    ("Mateus Allebrand", "Mat",generate_password_hash("1234").decode("utf-8") ),
    ("Mariana Alves", "Mari",generate_password_hash("4567").decode("utf-8") ),
    ("Gabrielli Sena", "Gabi",generate_password_hash("1236").decode("utf-8") )
]
